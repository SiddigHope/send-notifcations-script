...
<div id="page-" class="col-md-4 col-md-offset-4">
	<form class="form loginform" method="POST" action="authenticate.php">
		<div class="login-panel panel panel-default">
			<div class="panel-heading">يرجى تسجيل الدخول</div>
			<div class="panel-body">
				...
				<div class="checkbox">
					<label class="row" style="margin-right:0">
						<input name="remember" type="checkbox" value="1" style="position:unset; margin-left:5px">
						 تذكرني
					</label>
				</div>
				...
				<?php endif; ?>
				<button type="submit" class="btn btn-success loginField">تسجيل دخول</button>
			</div>
		</div>
	</form>
</div>
